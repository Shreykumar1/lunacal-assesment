...
const AboutCard = () => {
    ...
    return (
        <div className="bg-[#363C43]  w-[720px] h-[325px] rounded-[18.89px] shadow-[5.67px_5.67px_3.78px_0px_rgba(0,0,0,0.4)] flex relative">
            ...
            <div className="h-full flex flex-col justify-center items-center pt-10 mx-12 gap-10">
                <div ref={buttonContainerRef} className="bg-[#171717] text-[#A3ADB2] about-header w-full h-16 rounded-3xl flex justify-evenly items-center text-lg font-medium ">
                    ...
                    {["About Me", "Experiences", "Recommended"].map((label, index) => (
                        <button
                            key={index}
                            className={`relative overflow-hidden font-medium text-[#969696] w-full py-3 mx-2 rounded-2xl ${selectedButton === index
                                    ? "  text-white     "
                                    : "bg-[#171717]"
                                }`}
                ...
                <div className="mdoc text-ellipsis  mb-2 text-[#969696] text-xl leading-6  ">
